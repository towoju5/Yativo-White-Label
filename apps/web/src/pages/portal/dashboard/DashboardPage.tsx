...
export default function PortalDashboardPage() {
  ...
  return (
    <T.DashboardLayout
      title="Welcome back"
      subtitle="Here's what's happening across your accounts"
      ...
      stats={[
        ...
        { label: "Wallets", value: String(walletsQuery.data?.length ?? 0), icon: ArrowLeftRight },
        { label: "Recent activity", value: String(activity.length), icon: TrendingUp },
      ]}
      wallets={wallets}
      activity={activity}
