...
export async function portalCardsRoutes(app: FastifyInstance) {
  ...
  server.get(
    "/portal/cards",
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { response: { 200: z.array(cardSchema) } } },
    async (request, reply) => {
  ...
  server.post(
    "/portal/cards",
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { body: portalIssueCardSchema, response: { 200: cardSchema, 409: errorResponseSchema } } },
    async (request, reply) => {
  ...
  server.get(
    "/portal/cards/:id",
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { params: idParam, response: { 200: cardDetailSchema, 404: errorResponseSchema } } },
    async (request, reply) => {
  ...
  server.post(
    ...
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { params: idParam, response: { 200: cardRevealSchema, 404: errorResponseSchema } } },
    async (request, reply) => {
  ...
  server.get(
    ...
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { params: idParam, response: { 200: z.array(cardTransactionSchema), 404: errorResponseSchema } } },
    async (request, reply) => {
  ...
  server.post(
    ...
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { params: idParam, body: cardAmountSchema, response: { 200: cardSchema, 409: errorResponseSchema } } },
    async (request, reply) => {
  ...
  server.post(
    ...
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { params: idParam, response: { 200: cardSchema, 404: errorResponseSchema } } },
    async (request, reply) => {
  ...
  server.post(
    ...
    { preHandler: [requireCustomerAuth, requirePortalPermission("cards.manage")], schema: { params: idParam, body: setAirlinePaymentsSchema, response: { 200: cardSchema, 404: errorResponseSchema } } },
    async (request, reply) => {
