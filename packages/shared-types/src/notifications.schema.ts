...
export const EMAIL_NOTIFICATION_CATALOG: { type: EmailNotificationType; label: string; description: string; group: string; variables: string[] }[] = [
  ...
  { type: "CARD_ISSUED", label: "Virtual card issued", description: "Sent when a new virtual card is issued.", group: "Virtual Cards", variables: ["last4"] },
  { type: "CARD_FROZEN", label: "Virtual card frozen", description: "Sent when a virtual card is frozen.", group: "Virtual Cards", variables: ["last4"] },
  { type: "CARD_UNFROZEN", label: "Virtual card unfrozen", description: "Sent when a virtual card is unfrozen.", group: "Virtual Cards", variables: ["last4"] },
  { type: "CARD_TERMINATED", label: "Virtual card terminated", description: "Sent when a virtual card is permanently closed.", group: "Virtual Cards", variables: ["last4"] },
  { type: "CARD_TRANSACTION", label: "Virtual card purchase", description: "Sent when a virtual card transaction completes.", group: "Virtual Cards", variables: ["amount", "currency", "merchant"] },
  { type: "BUSINESS_SPEND_CARD_ISSUED", label: "Business Card issued", description: "Sent when a new Business Card is issued.", group: "Business Cards", variables: ["maskedPan"] },
  { type: "BUSINESS_SPEND_CARD_ACTIVATED", label: "Business Card activated", description: "Sent when a Business Card is activated.", group: "Business Cards", variables: ["maskedPan"] },
  { type: "BUSINESS_SPEND_CARD_SUSPENDED", label: "Business Card suspended", description: "Sent when a Business Card is suspended.", group: "Business Cards", variables: ["maskedPan"] },
  { type: "BUSINESS_SPEND_CARD_TERMINATED", label: "Business Card terminated", description: "Sent when a Business Card is permanently closed.", group: "Business Cards", variables: ["maskedPan"] },
