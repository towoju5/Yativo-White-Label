...
export const PERMISSION_CATALOG: { key: StaffPermission; label: string; group: string; description: string }[] = [
  ...
  { key: "businessSpendCards.manage", label: "Manage Business Cards", group: "Payments", description: "Issue, fund, withdraw, activate/suspend, terminate, or update the PIN/limits of a Business Card." },
